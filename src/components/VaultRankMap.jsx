...
const RANK_DATA = {
  ...
  D: { name: 'Scraping By', sub: 'Foundations forming. Keep the lights on.',
    tracks: [
      { n: 'The Saver',    v: 'Bank balance: $10,000+',    p: 30 },
      { n: 'The Investor', v: 'Stocks/ETFs: $10,000+',     p: 25 },
      { n: 'Crypto Degen', v: 'Crypto: $10,000+',          p: 28 },
      { n: 'The Planner',  v: 'Savings rate: 25%+',        p: 35 },
      { n: 'The Builder',  v: 'Super: $15,000+',           p: 20 },
      { n: 'Debt Slayer',  v: '10% of total debt repaid',  p: 15 },
    ],
    bonus: [
  ...
  C: { name: 'Getting There', sub: 'Momentum is building. This is real now.',
    tracks: [
      { n: 'The Saver',    v: 'Bank balance: $20,000+',    p: 55 },
      { n: 'The Investor', v: 'Stocks/ETFs: $25,000+',     p: 50 },
      { n: 'Crypto Degen', v: 'Crypto: $25,000+',          p: 48 },
      { n: 'The Planner',  v: 'Savings rate: 35%+',        p: 55 },
      { n: 'The Builder',  v: 'Super: $40,000+',           p: 45 },
      { n: 'Debt Slayer',  v: '25% of total debt repaid',  p: 35 },
    ],
    bonus: [
  ...
  B: { name: 'Wealth Aware', sub: 'You know the game. Now compound it hard.',
    tracks: [
      { n: 'The Saver',    v: 'Bank balance: $40,000+',    p: 72 },
      { n: 'The Investor', v: 'Stocks/ETFs: $60,000+',     p: 68 },
      { n: 'Crypto Degen', v: 'Crypto: $50,000+',          p: 65 },
      { n: 'The Planner',  v: 'Savings rate: 45%+',        p: 70 },
      { n: 'The Builder',  v: 'Super: $80,000+',           p: 60 },
      { n: 'Debt Slayer',  v: '40% of total debt repaid',  p: 55 },
    ],
    bonus: [
  ...
  A: { name: 'Wealth Builder', sub: 'Serious numbers. The vault is in sight.',
    tracks: [
      { n: 'The Saver',    v: 'Bank balance: $80,000+',    p: 85 },
      { n: 'The Investor', v: 'Stocks/ETFs: $120,000+',    p: 82 },
      { n: 'Crypto Degen', v: 'Crypto: $100,000+',         p: 80 },
      { n: 'The Planner',  v: 'Savings rate: 55%+',        p: 85 },
      { n: 'The Builder',  v: 'Super: $150,000+',          p: 78 },
      { n: 'Debt Slayer',  v: '60% of total debt repaid',  p: 72 },
    ],
    bonus: [
  ...
  S: { name: 'The Vault', sub: '$600,000+ net worth. All tracks maxed. Legendary.',
    tracks: [
      { n: 'The Saver',    v: 'Bank balance: $150,000+',   p: 100 },
      { n: 'The Investor', v: 'Stocks/ETFs: $250,000+',    p: 100 },
      { n: 'Crypto Degen', v: 'Crypto: $200,000+',         p: 100 },
      { n: 'The Planner',  v: 'Savings rate: 65%+',        p: 100 },
      { n: 'The Builder',  v: 'Super: $280,000+',          p: 100 },
      { n: 'Debt Slayer',  v: '80% of total debt repaid',  p: 100 },
    ],
    bonus: [
