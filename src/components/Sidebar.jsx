const NAV = [
  ...
  { id: 'trades',    label: 'Trades',    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M7 7h13l-3-3M17 17H4l3 3"/><path d="M7 7v5M17 17v-5"/></svg> },
  ...
  { id: 'vaultrank', label: 'Vault Rank', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M8 21h8M12 21V9M5 3l2 6h10l2-6"/><path d="M5 3H3M19 3h2"/></svg> },
]
